...
/////////for sorting only///////////////
#define USE_SHARED_MEMORY_ENALBLE
...
void cl_getKernel(char* kernelName,cl_kernel *kernel,int CPU_GPU);
...
#define HOST_MALLOC(PTR,SIZE) PTR=(void *)alignedMalloc(SIZE); //malloc
#define HOST_FREE(PTR) alignedFree(PTR)                        //free
